import { LETTER } from 'lib/utils/constants';
...
`;
  ...
  return `If you wish to reply to this email please respond to ${
    referrerData['referer-name'] || 'referrer'
  } at ${referrerData['referer-email'] || ''} 
