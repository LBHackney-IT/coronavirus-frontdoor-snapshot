...
import GetTemplatePreview from './use-cases/get-template-preview';
...
const getTemplatePreview = withLogging(
  new GetTemplatePreview({ notifyGateway, referralGateway, logger }),
  logger
);
