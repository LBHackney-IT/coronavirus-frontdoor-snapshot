...
const createReferral = withLogging(
  new CreateReferral({ referralGateway, logger})
);
...
const findReferrals = withLogging(
  new FindReferrals({ referralGateway, logger}),
  logger
);
const getReferral = withLogging(
  new GetReferral({ referralGateway, logger }),
  logger
);
const updateReferral = withLogging(
  new UpdateReferral({ referralGateway, logger }),
  logger
);
...
const sendReferralEmail = withLogging(
    new SendReferralEmail({ notifyGateway, logger}),
    logger
);
